...
@section('page_subtitle', 'Enregistrer dans l\'inventaire')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 lg:p-6">
        <form method="POST" action="{{ route('gestionnaire.materiels.store') }}" class="space-y-4">
            @csrf
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1.5">Quantité en stock <span class="text-red-500">*</span></label>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" rows="3" placeholder="Notes..."
