...
<head>
    ...
    <title>@yield('title', 'Admin') — GestMatériel</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="sidebar sidebar-drawer lg:relative lg:translate-x-0 lg:flex lg:flex-col w-64 flex-shrink-0"
        ...
        <nav class="flex-1 px-3 py-3 overflow-y-auto">
            <p class="sidebar-section">Menu principal</p>
            ...
            <a href="{{ route('admin.gestionnaires.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.gestionnaires.*') ? 'active' : '' }}"
               @click="sidebarOpen = false">
                <i class="fa-solid fa-users-gear"></i> Gestionnaires
            </a>
            <p class="sidebar-section">Analyse</p>
            <a href="{{ route('admin.statistiques') }}"
               class="sidebar-link {{ request()->routeIs('admin.statistiques') ? 'active' : '' }}"
               @click="sidebarOpen = false">
                <i class="fa-solid fa-chart-pie"></i> Statistiques globales
            </a>
        </nav>
